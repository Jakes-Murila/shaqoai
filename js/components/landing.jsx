...
function Nav(){
  ...
  return (
    ...
    <div className={`fixed inset-0 z-[60] md:hidden transition-all duration-300 ${open ? 'pointer-events-auto' : 'pointer-events-none'}`}>
      ...
      <div className={`absolute top-0 right-0 h-full w-[78%] max-w-xs bg-white shadow-2xl transition-transform duration-300 ${open? 'translate-x-0':'translate-x-full'} p-6 flex flex-col`}>
